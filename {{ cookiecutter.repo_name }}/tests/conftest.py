...
def temp_dir() -> Generator[Path, None, None]:
    """Create e new unique temp dir that gets cleaned up after tests"""
    tmp: Path = platformdirs.user_data_path(appname="{{ cookiecutter.package_name }}") / "temp" / str(uuid.uuid4())
